...
WHY:
I wanted to improve upon MySpace.
...
I coded everything for Let's Ask Bobby using the Notepad app on Windows. I remember frequently having to count through thousands of lines of code in different files just to locate the source of specific errors.</p>
        </div>
    )
}